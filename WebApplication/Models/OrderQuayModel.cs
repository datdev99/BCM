...
{
    public class OrderQuayModel
    {
        public DataSet GetOrderQuay(string date)
        {
            ...
            try
            {
                ...
                cmd.Parameters.AddWithValue("@Action", "GetOrderQuay");
        ...
        public DataTable GetDanhSachDichVu()
        {
            ...
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("sp_orderQuay", _cnn);
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.AddWithValue("@Action", "GetDanhSachDichVu");
        ...
        public string postOrderQuay(DataTable tb)
        {
            SqlConnection _cnn = null;
